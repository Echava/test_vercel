...
import {
  ...
  UNINITIALIZED
} from "./chunk-AUK5H52A.js";
import {
  subscribe_to_store
} from "./chunk-KPOE6FHL.js";
import {
  DEV,
  is_promise,
  noop
} from "./chunk-JTPGC27M.js";
...
function is_tag_valid_with_parent(tag, parent_tag) {
  if (tag.includes("-") || (parent_tag == null ? void 0 : parent_tag.includes("-"))) return true;
  if (parent_tag !== null) {
...
function print_error(payload, parent2, child) {
  var message = (parent2 === null ? `node_invalid_placement_ssr: ${stringify(child)} needs a valid parent element

` : `node_invalid_placement_ssr: ${stringify(parent2)} cannot contain ${stringify(child)}
...
//# sourceMappingURL=chunk-N4KQ6TAD.js.map
